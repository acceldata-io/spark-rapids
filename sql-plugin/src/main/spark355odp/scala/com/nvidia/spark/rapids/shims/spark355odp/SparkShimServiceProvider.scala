...
{"spark": "355odp"}
spark-rapids-shim-json-lines ***/
package com.nvidia.spark.rapids.shims.spark355odp

import com.nvidia.spark.rapids.{AcceldataShimVersion, ShimVersion}

object SparkShimServiceProvider {
  val VERSION = AcceldataShimVersion(3, 5, 5, "3.3.6.501-SNAPSHOT")
  val ODP_BASE_VERSION = "3.5.5.3.3.6.501-SNAPSHOT"
}
