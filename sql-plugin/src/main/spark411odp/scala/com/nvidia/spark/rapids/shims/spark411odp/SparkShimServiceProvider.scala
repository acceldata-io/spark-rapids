...
{"spark": "411odp"}
spark-rapids-shim-json-lines ***/
package com.nvidia.spark.rapids.shims.spark411odp

import com.nvidia.spark.rapids.{AcceldataShimVersion, ShimVersion}

object SparkShimServiceProvider {
  val VERSION = AcceldataShimVersion(4, 1, 1, "3.3.6.501-SNAPSHOT")
  val ODP_BASE_VERSION = "4.1.1.3.3.6.501-SNAPSHOT"
}
